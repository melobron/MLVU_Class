...
from GOPRO_Large import GOPRO_Large_train_sharp_128
...
if __name__ == "__main__":
    batch_size = 4
    img_size = 128
    # root = './datasets/GOPRO_Large/sharp_train_128'
    ...
    data = GOPRO_Large_train_sharp_128()
    ...
    print('Train Start')
    ddpm.train(epoch=50, verbose=10)
